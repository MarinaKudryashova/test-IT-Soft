...
/* harmony import */ var _components_headerheight__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/headerheight */ "./src/js/components/headerheight.js");
/* harmony import */ var _components_phonelist__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/phonelist */ "./src/js/components/phonelist.js");
...
/***/ "./src/js/components/headerheight.js":
/*!*******************************************!*\
  !*** ./src/js/components/headerheight.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
// }
document.addEventListener("DOMContentLoaded", () => {
  if ((0,_functions_check_viewport__WEBPACK_IMPORTED_MODULE_1__.isMobile)() || (0,_functions_check_viewport__WEBPACK_IMPORTED_MODULE_1__.isTablet)()) {
...
/***/ "./src/js/components/phonelist.js":
/*!****************************************!*\
  !*** ./src/js/components/phonelist.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
document.addEventListener('DOMContentLoaded', event => {
  if ((0,_functions_check_viewport__WEBPACK_IMPORTED_MODULE_0__.isMobile)() || (0,_functions_check_viewport__WEBPACK_IMPORTED_MODULE_0__.isTablet)()) {
    const btnOpen = document.querySelector('.phonelist__btn');
    const phoneList = document.querySelector('.phonelist__container');
    const phoneLink = document.querySelectorAll('.phonelist__link');
    btnOpen.addEventListener('click', e => {
      btnOpen.classList.toggle('is-open');
      phoneList.classList.toggle('is-open');
      phoneLink.forEach(link => {
        link.addEventListener('click', e => {
          btnOpen.classList.remove('is-open');
          phoneList.classList.remove('is-open');
        });
      });
    });
  }
...
document.addEventListener('DOMContentLoaded', event => {
  const photoSlider = document.querySelector('.photoslider__swiper');
  if (photoSlider) {
    const swiperPhotoSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](photoSlider, {
      loop: true,
      spaceBetween: 20,
      slidesPerView: 1,
      effect: "fade",
      speed: 800,
      navigation: {
        nextEl: ".photoslider__btn-next",
        prevEl: ".photoslider__btn-prev"
      }
    });
  }
  ...
  if (catalogSlider) {
    resizableSwiper('(max-width: 1024px)', '.catalog__slider', {
      lazy: true,
      slidesPerView: 2,
      spaceBetween: 20,
...
const form = document.querySelector('.bannerform__form');
const username = form.querySelector('[name="username"]');
const tel = form.querySelector('[type="tel"]');
const email = form.querySelector('[type="email"]');
const agree = form.querySelector('[type="checkbox"]');
...
//функция создает текст с ошибкой
function creatError(input, text) {
  input.classList.add('not-valid');
  // создаем параграф с ошибкой
  let errorText = document.createElement('span');
  errorText.className = 'form-field__error';
  errorText.textContent = text;
  input.parentNode.append(errorText);
}

//функция удаляет текст ошибкой
function removeError(input) {
  if (input.classList.contains('not-valid')) {
    input.classList.remove('not-valid');
    input.parentNode.querySelector('.form-field__error').remove();
  }
}

// ф-ция проверика имени
function isValidUsername(input) {
  removeError(input); //очищаем ошибки
  // проверяем, заполнено ли поле
  if (input.value === "") {
    creatError(input, 'Введите ваше имя');
    return false;
  }
  // проверка кол-ва символов
  if (input.value.length <= 3) {
    creatError(input, 'Имя содержит менее 3 символов');
    return false;
  }
  // проверка кол-ва символов
  if (input.value.length > 30) {
    creatError(input, 'Слишком длинное имя');
    return false;
  }
  return true;
}

// ф-ция проверика телефона
function isValidTel(input) {
  removeError(input); //очищаем ошибки
  // проверяем, заполнено ли поле
  if (input.value === "") {
    creatError(input, 'Введите ваш номер телефона');
    return false;
  }
  // проверка паттерном
  if (input.value.length > 0) {
    ...
    if (value.length < 10 || value[0] !== "7") {
      creatError(input, 'Не корректный номер телефона');
      return false;
    }
  }
  return true;
...
// ф-ция проверика email
function isValidEmail(input) {
  removeError(input); //очищаем ошибки
  // проверяем, заполнено ли поле
  if (input.value === "") {
    creatError(input, 'Введите ваш email');
    return false;
  }
  // проверка паттерном
  const emailRegExp = /^[\w]{1}[\w-\.]*@[\w-]+\.[a-z]{2,4}$/i;
  let valid = emailRegExp.test(input.value);
  if (!valid) {
    creatError(input, 'Не корректный email');
    return valid;
  }
  return true;
}
...
// ф-ция проверика согласия
agree.addEventListener('change', e => {
  form.querySelector('[type="submit"]').disabled = !e.currentTarget.checked;
});
